window.addEventListener("load", function () {
  var listSlider = document.querySelector('.list-sliders'),
    ...
    openPopup = document.querySelectorAll('.map-feedback'),
    closePopup = popup.querySelectorAll('.close-up'),
  ...
  var switchSlider = function (breadcrumbs) {
    var addSwitchSliderClick = function (breadcrumb, element, fon) {
      breadcrumb.addEventListener('click', function () {
        ...
        switch (fon) {
          case fon = 0:
            fonBody.classList.add('fon-1', 'fon-shine-1');
            break;
          case fon = 1:
            fonBody.classList.add('fon-2', 'fon-shine-2');
            break;
          case fon = 2:
            fonBody.classList.add('fon-3', 'fon-shine-3');
            break;
        }
